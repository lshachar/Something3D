...
#define STRING_CONFIG_H_AUTHOR "(Shachar Hagever)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "4590"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_FUNCTIONAL_RANGE 20 // If the temperature difference between the target temperature and the actual temperature
								  ...
								  // pre 27.2.24 this was set to 10. NOTE!
  ...
  // a test with fan at 100% dispalys I don't have enough authority over the temp. 
  #define DEFAULT_Kp 161.35
  #define DEFAULT_Ki 50.00 // 24.63  (27.2 testing double the kI, but it wont work)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Something3D from pidautotune
  //#define DEFAULT_bedKp 73.68
  //#define DEFAULT_bedKi 7.56
  //#define DEFAULT_bedKd 478.84
...
#define USE_ZMAX_PLUG		// changed: used for the ABL sensor
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 7, 500 } // ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 5   // default: 10.0 , I changed it but did not enable in the first line! maybe try it sometime?
  #define DEFAULT_YJERK 5   // default: 10.0
  #define DEFAULT_ZJERK 0.1 // default: 0.3   
...
#define Z_MIN_PROBE_PIN 19   // Pin 19 is Z_MAX endstop, and it is unused on our Something3d Printer.
...
#define AUTO_BED_LEVELING_UBL	// changed (uncommented)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 0 	// changed from 1. I don't think we need it for something3d.             // Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 10	// changed from 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
